...
$app->post('/api/checklistitems/{id}', 'CheckListItemController@updateCheckListItem');
$app->delete('/api/checklistitems/{id}', 'CheckListItemController@deleteCheckListItem');
